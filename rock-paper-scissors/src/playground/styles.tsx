...
export const StyledStepTwo = styled(Box)(({ theme }) => ({
  ...
  "& .container": {
    ...
    width: "calc(1.1 * (var(--circle-radius) + var(--border-width)))",
  ...
  "& .circle": {
    ...
    "& .lvl1": {
      position: "absolute",
      width: "calc(var(--circle-radius) + 3.5 * var(--border-width))",
      height: "calc(var(--circle-radius) + 3.5 * var(--border-width))",
      background: "#ffffff66",
      borderRadius: "50%",
      zIndex: 2,
    },
    "& .lvl2": {
      position: "absolute",
      width: "calc(var(--circle-radius) + 7.5 * var(--border-width))",
      height: "calc(var(--circle-radius) + 7.5 * var(--border-width))",
      background: "#ffffff66",
      borderRadius: "50%",
      zIndex: 1,
    },    
    "& .lvl3": {
      position: "absolute",
      width: "calc(var(--circle-radius) + 11.5 * var(--border-width))",
      height: "calc(var(--circle-radius) + 11.5 * var(--border-width))",
      background: "#ffffff66",
      borderRadius: "50%",
      zIndex: 0,
    },
